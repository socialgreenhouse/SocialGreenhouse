 ...
 */
public class ModuleDetailActivity extends FragmentActivity
		implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putLong(
					ModuleDetailFragment.ARG_MODULE_SERIAL_NO,
					getIntent().getLongExtra(
							ModuleDetailFragment.ARG_MODULE_SERIAL_NO, -1));
			ModuleDetailFragment fragment = new ModuleDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.module_detail_container, fragment).commit();
		}
	}
